    ...
    def test_convert_log_data_work(self):
        list_of_logs = [{'_id': {'$oid': '60a3f9ef9f5cf6c89b8f22f1'},
                         'order': {'products': [{'item_id': '60a3f',
                                                 ...
                                                 'item_price': 10, 'item_quantity': 1},
                                                {'item_id': '60a3g', 'item_name': 'Percy Jackson e os Olimpianos',
                                                 'item_price': 5, 'item_quantity': 2},
                                                {'item_id': '60a3h', 'item_name': 'Biblia',
                                                 'item_price': 5, 'item_quantity': 500}],
